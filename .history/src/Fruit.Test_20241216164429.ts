...
function calculateStockAmount(fruitsStock: FruitsStock) {
    throw new Error("Function not implemented.");
}

function readFruitByName(state: State, arg1: string) {
    throw new Error("Function not implemented.");
}

function updateAvailableFruitQuantity(fruitsStock: FruitsStock, arg1: number, arg2: number): FruitsStock {
    throw new Error("Function not implemented.");
}

function sellFruit(fruitsStock: FruitsStock, arg1: number, arg2: number): FruitsStock {
    throw new Error("Function not implemented.");
}
