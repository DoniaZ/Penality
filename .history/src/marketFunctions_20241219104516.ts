...
export const isFruit = (value: any): value is Fruit => {
  return (
...
export const isFruitsStock = (value: any): value is FruitsStock => {
...
export const clearFruitsStock = (): FruitsStock => [];
