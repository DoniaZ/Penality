...
import { replayFromHistory } from "./replayFromHistory";
...
const exampleHistory: HistoryEntry[] = [
  {
    shotNumber: 1,
    score: { teamA: 1, teamB: 0 },
    result: { team: "Team A", scored: true },
  },
  {
    shotNumber: 2,
    score: { teamA: 1, teamB: 1 },
    result: { team: "Team B", scored: true },
  },
];

console.log("\nRejouer depuis l'historique:");
replayFromHistory(exampleHistory);
